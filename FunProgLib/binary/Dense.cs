...
namespace FunProgLib.binary
{
    ...
    public static class Dense
    {
        ...
        private static readonly LinkList<string>.List Zero = LinkList<string>.Cons(DigitShapes[0], null);
        private static readonly LinkList<string>.List One = LinkList<string>.Cons(DigitShapes[1], null);

        public static LinkList<string>.List Inc(LinkList<string>.List ds)
        {
            if (ds == null || ds == Zero) return One;
        ...
        {
            if (ds2 == null || ds2 == Zero) return ds1;
            if (ds1 == null || ds1 == Zero) return ds2;
