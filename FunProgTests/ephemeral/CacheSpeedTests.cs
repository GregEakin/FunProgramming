...
public class CacheSpeedTests
{
    ...
    // [Ignore]
    // [Fact]
    public async Task TimeVsBufferSize()
    {
        const int start = 18;
        ...
        {
            Console.WriteLine($"{testRun.Index, 4}\t{testRun.Memory.Length, 13:N0}\t{testRun.TimeWithout, 7:F2}\t{testRun.TimeWith, 7:F2}\t{testRun.TimeWith - testRun.TimeWithout, 7:F2}");
        }
    }
